...
var GameSale = function (item) {
    var filteredData = products_1["default"].filter(function (item) { return item.salePrice != null; });
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement("div", { className: "w-[1000px] flex flex-wrap justify-center" }, filteredData.map(cardItem))));
};
exports["default"] = GameSale;
